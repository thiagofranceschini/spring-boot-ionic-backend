...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "Limpeza e Manutenção");
		Categoria cat4 = new Categoria(null, "Segurança e EPIS");
		Categoria cat5 = new Categoria(null, "Marketing e promoção");
		Categoria cat6 = new Categoria(null, "Alimentação");
		Categoria cat7 = new Categoria(null, "Máquinas e Equipamentos Diversos");
		
		Produto prod1 = new Produto(null, "Computador", 2000.00);
		Produto prod2 = new Produto(null, "Impressora", 800.00);
		Produto prod3 = new Produto(null, "Mouse", 80.00);
		Produto prod4 = new Produto(null, "Mouse", 80.00);
		Produto prod5 = new Produto(null, "Mouse", 80.00);
		Produto prod6 = new Produto(null, "Mouse", 80.00);
		Produto prod7 = new Produto(null, "Mouse", 80.00);
		Produto prod8 = new Produto(null, "Mouse", 80.00);
		Produto prod9 = new Produto(null, "Mouse", 80.00);
		Produto prod10 = new Produto(null, "Mouse", 80.00);
		...
		prod1.getCategorias().addAll(Arrays.asList(cat2, cat4));
		...
		Cliente cli1 = new Cliente(null, "Thiago Franceschini", "tayfranceschini@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bpe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		Cliente cli2 = new Cliente(null, "Thamires Franceschini", "thiagoconsultor1@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bpe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.addPerfil(Perfil.ADMIN);
		Cliente cli3 = new Cliente(null, "Lorena Franceschini", "thiago.franceschini@resource.com", "36378912377", TipoCliente.PESSOAFISICA, bpe.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Av Sarah Veloso","1200", "Apto 164", "Jd. Metalúrgicos", "38777012", cli2, c2);
		Endereco e4 = new Endereco(null, "Alameda Nogueira","22", "Forest Hills", "Altos de São Fernando", "38777012", cli3, c3);
